...
priApp.controller('BanksController', function(
    $scope,
    moment,
    $window,
    $rootScope,
    ...
    function loadUsers() {
        try {
            $rootScope.db.collection('accounts').get().then(result => {
                const data = result.docs.map(doc => ({
                    id: doc.id,
                    ...doc.data(),
                }));
    ...
    $scope.addBank = function() {
        ...
        $rootScope.db
            ...
            .set({
                ...
                minBalance: `${$scope.account.minBalance}`,
                accountName: `${$scope.account.accountName}`,
                euro: `${$scope.account.euro}`,
                dolar: `${$scope.account.dolar}`,
                pound: `${$scope.account.pound}`,
                reyal: `${$scope.account.reyal}`,
                rupee: `${$scope.account.rupee}`,
                lira: `${$scope.account.lira}`,
            ...
            .then(() => {
                $scope.form = {};
                loadUsers();
                alert(`Bank was  successfully added!`);
